...
class PDFConstructor:
    ...
    def add_word(self, german_word, spanish_word, russian_word, english_word, sentences):
        word_story = []
        word_story.append(Paragraph(german_word, self._styles_constructor('Normal', 'left', font_size=14, bold=True)))
